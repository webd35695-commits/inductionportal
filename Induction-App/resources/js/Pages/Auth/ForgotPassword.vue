    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-white p-6">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
          <h1 class="text-xl font-semibold text-gray-800">Forgot Password</h1>
          <p class="text-sm text-gray-600">Enter your email to reset password</p>
        </div>

        <!-- Status Message -->
        <div v-if="status" class="mb-4 text-center text-sm text-green-600 bg-green-50 p-2 rounded">
          {{ status }}
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div class="text-center text-sm text-gray-600 space-y-1 mt-6">
            <p>Remember your password? <Link :href="route('login')" class="text-teal-600 hover:text-teal-800 underline">Sign in</Link></p>
