...
<template>
  ...
  <div v-else>
    ...
    <div class="min-h-screen flex">
      ...
      <!-- Left: Your Previous Color (darkslategrey) -->
      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center bg-white p-6">
        ...
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Sign in to FGEI Induction Portal</h1>
          ...
          <form @submit.prevent="submit" class="space-y-5">
            ...
            <div class="text-center text-sm text-gray-600 space-y-1 mt-6">
              <p>Don't have an account? <Link :href="route('register')" class="text-teal-600 hover:text-teal-800 underline">Signup</Link></p>
