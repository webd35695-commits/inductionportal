    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Edit Induction Phase</h2>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit"
                                ...
                                {{ form.processing ? 'Updating...' : 'Update Phase' }}
                            </button>
                        </div>
                    </form>
                </div>
...
const props = defineProps({
    inductionPhase: Object,
});

const form = useForm({
    title: props.inductionPhase.title,
    status: props.inductionPhase.status,
    start_date: props.inductionPhase.start_date,
    end_date: props.inductionPhase.end_date
});
...
const submit = () => {
    form.put(route('InductionPhase.update', props.inductionPhase.id));
};
