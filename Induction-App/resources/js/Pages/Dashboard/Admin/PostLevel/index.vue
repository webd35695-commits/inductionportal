    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Post Level Management</h2>
                <button
            ...
            <!-- Add Post Level Modal -->
            <AddPostLevelModal
                :isOpen="showModal"
                @close="showModal = false"
            />

            <!-- Edit Post Level Modal -->
            <EditPostLevelModal
                :isOpen="editModal"
                :postLevel="selectedPostLevel"
                @close="editModal = false"
            />

            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <table id="postLevelTable" class="w-full display responsive nowrap">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="level in post_levels" :key="level.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm font-medium border-b border-gray-200 whitespace-nowrap">
                                    <div class="flex space-x-3">
                                        ...
                                        <button
                                            @click="deletePostLevel(level.id)"
...
import AddPostLevelModal from '@/Components/AddPostLevelModal.vue';
import EditPostLevelModal from '@/Components/EditPostLevelModal.vue';
...
const selectedPostLevel = ref(null); // Store the post level being edited
...
const openEditModal = (postLevel) => {
    selectedPostLevel.value = postLevel;
    editModal.value = true;
};

const deletePostLevel = (id) => {
    if (confirm('Are you sure you want to delete this post level?')) {
        router.delete(route('post_levels.destroy', id), {
            preserveScroll: true,
            onSuccess: () => {
...
onMounted(() => {
    $('#postLevelTable').DataTable({
        ...
        language: {
            search: '',
            searchPlaceholder: 'Search post levels...',
