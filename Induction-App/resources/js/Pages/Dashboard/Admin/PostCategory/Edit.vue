    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Edit Post Category</h2>
            ...
            <SuccessPopup v-if="showMessage && (flashMessage || flashError)" :message="flashMessage || flashError" :isError="!!flashError" />
...
const form = useForm({
    ...
    status: props.postCategory.status,
});
...
const submit = () => {
    form.put(route('post-categories.update', props.postCategory.id), {
        onSuccess: () => {
