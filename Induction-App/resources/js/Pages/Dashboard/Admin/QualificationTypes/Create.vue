    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Create New Qualification Type</h2>
                <Link
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex justify-end mt-6">
                            ...
                            >
                                ...
                                <span v-else>Create Qualification Type</span>
                            </button>
                        </div>
                    </form>
                </div>
...
const submit = () => {
    ...
    form.post(route('qualification-types.store'), {
        onFinish: () => {
