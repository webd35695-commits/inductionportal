    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Roles | Permission</h2>
                <Link
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="Permission in Permissions" :key="Permission.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 border-b border-gray-200 whitespace-nowrap">
                                    <span
                                        :class="{
                                            'bg-green-100 text-green-800': Permission.status === 'Active',
                                            'bg-red-100 text-red-800': Permission.status === 'Inactive',
                                        }"
...
const deletePermission = (id) => {
    if (confirm('Dangerous Operation...!!Are you sure you want to delete this Permission?')) {
