    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Province Management</h2>
                <Link
 ...
 <SuccessPopup v-if="showDeleteSuccess && $page.props.flash.message"
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <table id="provinceTable" class="w-full display responsive nowrap">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="province in provinces" :key="province.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 border-b border-gray-200 whitespace-nowrap">
                                    <span
                                        :class="{
                                            'bg-green-100 text-green-800': province.status === 'Active',
                                            'bg-yellow-100 text-yellow-800': province.status === 'Pending',
                                            'bg-red-100 text-red-800': province.status === 'Inactive',
                                        }"
