        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Edit Province</h2>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input v-model="form.name" id="name" type="text" required
                                        placeholder="Enter Province name (e.g. Gilgit Baltistan)"
                                ...
                                <div>
                                    ...
                                    <p v-if="form.errors.status" class="mt-1 text-sm text-red-600">{{ form.errors.status }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-end space-x-3">
                                ...
                                <button type="submit"
                                    ...
                                    {{ form.processing ? 'Updating...' : 'Update Province' }}
                                </button>
                            </div>
                        </form>
                    </div>
