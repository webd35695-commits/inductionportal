    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Qualification Category Management</h2>
                <Link
                    :href="route('qualification-categories.create')"
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <table id="qualificationCategoryTable" class="w-full display responsive nowrap">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase border-b border-gray-200">Qualification Type</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="category in qualificationCategories" :key="category.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 border-b border-gray-200 whitespace-nowrap">
                                    {{ category.qualification_type.name }}
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-500 border-b border-gray-200 whitespace-nowrap">
                                    <span
                                        :class="{
                                ...
                                <td class="px-6 py-4 text-sm font-medium border-b border-gray-200 whitespace-nowrap">
                                    <div class="flex space-x-3">
                                        <Link
                                            :href="route('qualification-categories.show', category.id)"
                                        ...
                                        <Link
                                            :href="route('qualification-categories.edit', category.id)"
...
const deleteCategory = (id) => {
    if (confirm('Are you sure you want to delete this qualification category?')) {
        router.delete(route('qualification-categories.destroy', id), {
            preserveScroll: true,
            onSuccess: () => {
...
onMounted(() => {
    $('#qualificationCategoryTable').DataTable({
        responsive: true,
        ...
        language: {
            search: '',
            searchPlaceholder: 'Search qualification categories...',
