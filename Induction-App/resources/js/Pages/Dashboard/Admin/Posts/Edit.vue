...
const form = useForm({
  induction_phase_id: props.post.induction_phase_id || "",
  post_category_id: props.post.post_category_id || "",
  qualification_type_id: props.post.qualification_type_id || "",
  name: props.post.name || "",
  number_post: props.post.number_post || "",
  fee_post: props.post.fee_post ?? 0,
  min_age: props.post.min_age || "",
  max_age: props.post.max_age || "",
  post_abbreviation: props.post.post_abbreviation || "",
  post_gender: props.post.post_gender || "Both",
  bps: props.post.bps || "",
  requirements: props.post.requirements || "",
  degree_required: props.post.degree_required || false,
});
