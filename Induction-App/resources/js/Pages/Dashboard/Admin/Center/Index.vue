    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Center Management</h2>
                <Link
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <table id="qualificationCentersTable" class="w-full display responsive nowrap">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase border-b border-gray-200">City</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="Centers in Center" :key="Centers.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 border-b border-gray-200 whitespace-nowrap">
                                    <span
                                        :class="{
                                            'bg-green-100 text-green-800': Centers.status === 'Active',
                                            'bg-red-100 text-red-800': Centers.status === 'Inactive',
                                        }"
                                ...
                                <td class="px-6 py-4 text-sm font-medium border-b border-gray-200 whitespace-nowrap">
                                    <div class="flex space-x-3">
                                        <!-- <Link
                                            :href="route('Centers.show', Centers.id)"
                                        ...
                                        <Link
                                            :href="route('Centers.edit', Centers.id)"
...
onMounted(() => {
    $('#qualificationCentersTable').DataTable({
        responsive: true,
